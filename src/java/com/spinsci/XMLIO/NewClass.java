            ...
            SAXParserFactory factory = SAXParserFactory.newInstance();
    	      ...
    	      DefaultHandler handler = new DefaultHandler() {
    	        ...
    	        public void startElement(String uri, String localName,
    	            ...
    	            throws SAXException {
                      try {
                          out.println("Start Element :" + qName);
                          rotatingKey = qName;
    	        ...
    	        public void characters(char ch[], int start, int length)
    	          ...
    	          if (bfname) {
                          ...
                          out.println("BFCharacters: "+new String(ch, start, length));
                  ...
                  {
                      try {
                          out.println("Getting charsting for "+rotatingKey);
                          JSONObject dirtyPair = new JSONObject();                          
                          String oneString = new String(ch, start, length);
                          out.println("Characters: "+oneString);
                          dirtyPair.put(rotatingKey,oneString);
                          innerJ.add(dirtyPair);
                          out.println("Finished getting charsting for "+rotatingKey);
                      } catch (Exception ex) {
                          Logger.getLogger(NewClass.class.getName()).log(Level.SEVERE, null, ex);
                      }                      
                  }
                    try {
                        out.println(innerJ.toJSONString());
                    } catch (IOException ex) {
                        Logger.getLogger(NewClass.class.getName()).log(Level.SEVERE, null, ex);
                    }
